    ...
    <>
      ...
      <header className="sr-only">
        ...
        <section>
          <h2>서비스 소개</h2>
          <p>
            ChuChuTree는 백준 온라인 저지와 solved.ac의 데이터를 분석하여 개인 맞춤형 알고리즘 문제를 추천하는 학습 캘린더 서비스입니다. 알고리즘 문제 풀이 기록을 시각화하고, 취약한 알고리즘 유형을
            파악하여 효율적인 학습 경로를 제시합니다. 코딩테스트 준비생, PS 학습자, 알고리즘 공부를 시작하는 모든 분들을 위한 최적의 학습 도우미입니다.
          </p>
        </section>
        ...
        <section>
          <h2>주요 알고리즘 유형</h2>
          <p>
            ChuChuTree는 구현, 그리디, 문자열, 브루트포스, 다이나믹 프로그래밍, 그래프 이론, DFS, BFS, 백트래킹, 분할정복, 이분탐색, 정렬, 자료구조, 트리, 수학, 정수론, 조합론 등 다양한 알고리즘
            유형을 체계적으로 관리합니다. 각 유형별로 초급, 중급, 고급, 마스터 레벨로 분류하여 단계적 학습을 지원합니다.
          </p>
        </section>
      </header>
