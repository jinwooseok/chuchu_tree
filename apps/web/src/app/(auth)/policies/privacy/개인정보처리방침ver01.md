...
ChuChuTree(이하 '회사'라고 함)는 회사가 제공하고자 하는 서비스(이하 '회사 서비스')를 이용하는 개인(이하 '이용자' 또는 '개인')의 정보(이하 '개인정보')를 보호하기 위해, 개인정보보호법, 정보통신망 이용촉진 및 정보보호 등에 관한 법률(이하 '정보통신망법') 등 관련 법령을 준수하고, 서비스 이용자의 개인정보 보호 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보처리방침(이하 '본 방침')을 수립합니다.
...
1. 필수 수집 정보: 이메일 주소 (동의 없이 처리)
2. 서비스 제공을 위한 정보
    - solved.ac 닉네임 (본인의 닉네임이 아니어도 무방하며, 해당 닉네임의 공개 정보를 solved.ac API를 통해 조회하여 서비스에 제공)
...
4. 네이버, 구글, 깃허브, 카카오 소셜로그인을 통한 정보 제공 동의
...
5. 회원 식별 및 서비스 제공, solved.ac 데이터 연동

## 제9조(개인정보의 처리 위탁)

회사는 원활한 서비스 제공과 효과적인 업무를 처리하기 위하여 다음 각 호와 같이 개인정보를 처리 위탁하고 있습니다.

1. 네이버(주), Google LLC, GitHub, Inc., 카카오(주)에게 소셜로그인 서비스 제공를 위하여 회원 탈퇴 시 또는 위탁 계약 종료 시까지동안 개인정보처리를 위탁함
...
1. 이용자는 언제든지 다음의 방법으로 개인정보를 조회하거나 수정할 수 있습니다.
   - 회사 홈페이지 > 개인정보
   - 개인정보보호 책임자에게 이메일(happynj2697@gmail.com)연락
2. 회원 탈퇴 방법:
   - 회사 홈페이지 > 회원 탈퇴
   - 탈퇴 시 모든 개인정보가 삭제됩니다 (법령에 따른 보관 정보 제외)
...
1. 회사는 이용자의 개인정보를 보호하고 개인정보와 관련한 불만을 처리하기 위하여 아래와 같이 관련 부서 및 개인정보 보호 책임자를 지정하고 있습니다.
   ...
   - 1) 성명: 임남기
   - 2) 직책: 대표
   - 3) 이메일: happynj2697@gmail.com

## 제30조(개인정보 전송요구권)

1. 이용자는 본인의 개인정보를 정보주체 또는 정보주체가 지정한 제3자에게 
전송할 것을 요구할 수 있습니다. 전송 요구는 개인정보보호 책임자에게 
이메일(happynj2697@gmail.com)로 요청하실 수 있습니다.
