...
export function OnboardingHeader() {
  ...
  return (
    <div className="fixed top-4 right-4 z-[60] flex items-center gap-3">
      {/* 현재 단계 표시 */}
      <div className="bg-background/95 backdrop-blur-sm flex items-center gap-2 rounded-lg border px-4 py-2 shadow-lg">
      ...
      {/* 종료 버튼 */}
      <Button variant="ghost" size="sm" onClick={completeOnboarding} className="gap-1">
        <X className="h-4 w-4" />
        <span>종료</span>
      </Button>
    </div>
