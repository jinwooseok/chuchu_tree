...
export default function NotFound() {
  return (
    <div className="bg-background flex min-h-screen w-full flex-col items-center justify-center">
      ...
      <Link aria-label="홈으로 돌아가기" title="홈으로 돌아가기" href="/chu" className="cursor-target bg-no2 text-foreground hover:bg-no2/50 trasition mt-10 rounded-lg px-4 py-2 duration-300">
        Come Back Home Bebe
      </Link>
