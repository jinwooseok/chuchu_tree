...
export default function PrivacyPolicyClient({ markdownContent }: PrivacyPolicyClientProps) {
  ...
  return (
    <div className="bg-innerground-white flex h-full w-full max-w-4xl flex-col overflow-auto rounded-xl px-8 py-4">
      ...
      <div className="flex flex-1 cursor-default flex-col select-none">
        <div className="mb-8">
          <h1 className="mb-2 cursor-default text-2xl font-semibold">개인정보 처리방침</h1>
